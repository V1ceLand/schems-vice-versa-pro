...
## Сайт-витрина приложения «Пары»

В каталоге `pairs-demo/` лежит отдельная статическая страница-продажник
Android-приложения «Пары» (расписание, задания, группа). Она не связана
с каталогом схематик и разворачивается независимо — см. `pairs-demo/README.md`.
