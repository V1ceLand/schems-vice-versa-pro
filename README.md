...
## Демонстрационный сайт приложения «Пары»

В каталоге `pairs-demo/` лежит отдельная статическая витрина Android-приложения
«Пары» (расписание, задания, группа). Она не связана с каталогом схематик и
разворачивается независимо — см. `pairs-demo/README.md`.
